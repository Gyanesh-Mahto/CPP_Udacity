...
Add std::string name to class Person.
Create a constructor for class Person.
Add an initializer list to the constructor.
Create class object.
*/
#include<iostream>
using namespace std;
...
class Person
{
    string name;
    public:
    Person(string n):name(n)    //Initializer list
    {}
    void print()
    {
        cout<<name<<endl;
